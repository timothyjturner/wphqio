    ...
    while (have_posts()) : the_post();
        ...
        <?php if ($popup) : ?>
            <div class="wphq-popup" id="wphq-popup" hidden>
                ...
                <button class="wphq-popup__expand" type="button" aria-expanded="false" aria-label="Expand offer"><span class="wphq-popup__expand-label">Learn more</span><span class="wphq-popup__expand-icon" aria-hidden="true">⌃</span></button>
        ...
        document.addEventListener('DOMContentLoaded',function(){
          ...
          var expand=popup.querySelector('.wphq-popup__expand'),expandLabel=popup.querySelector('.wphq-popup__expand-label');expand.addEventListener('click',function(){var open=popup.classList.toggle('is-expanded');expand.setAttribute('aria-expanded',open?'true':'false');expand.setAttribute('aria-label',open?'Collapse offer':'Expand offer');expandLabel.textContent=open?'See less':'Learn more'});
        });
